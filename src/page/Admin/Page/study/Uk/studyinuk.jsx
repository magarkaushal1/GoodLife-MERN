          ...
          <div className='container'>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Study In UK</li>
                            ...
                            <tbody key={el._id}>
                              <tr>
                                ...
                                <div className='button' style={{display: "flex"}}>
                                    <Link to={`/admin/studyinuk/show/${el._id}`}>
                                    <button
                                    ...
                                    <Link to={`/admin/studyinuk/update/${el._id}`}>
