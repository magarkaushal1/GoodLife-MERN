...
export default function UpdateAbout() {
    ...
    function handleSubmit(event) {
        ...
        let { images, title, description, vision, mission } = data
        ...
        axios.put(`${process.env.REACT_APP_SERVER_URL}/abouts/${id}`, form_data, {
            headers: {
        ...
        <div className='container'>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark " >About Us</a></li>
            ...
            <div className="container shadow my-5">
                ...
                <form onSubmit={handleSubmit} className='row g-3'>
                    ...
                    <div class="col-md-12">
                        <label htmlFor="vision" class="form-label required">
                            Vision
                        </label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"
                            name="vision" value={data.vision}
                            onChange={handleChange}>
                        </textarea>
                        <ErrorText
                            errors={errors}
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"
                            name="mission" value={data.mission}
                            onChange={handleChange}>
                        </textarea>
                        <ErrorText
                            errors={errors}
