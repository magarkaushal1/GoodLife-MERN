...
export default function UpdateGMAT() {
    ...
    function handleSubmit(event) {
        ...
        let { images, des, title, content,  subtitle1,des1,subtitle2,des2,
            subtitle3,des3,subtitle4,des4, subtitle5, des5} = data
        ...
        axios.put(`${process.env.REACT_APP_SERVER_URL}/gmat/${id}`, form_data, {
            headers: {
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark " >GMAT</a></li>
            ...
            <div className="container shadow my-5">
                ...
                <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="subtitle5" className="form-control" name="subtitle5" value={data.subtitle5}
                            onChange={handleChange}
                            aria-describedby="emailHelp" />
                        <ErrorText
                            errors={errors}
