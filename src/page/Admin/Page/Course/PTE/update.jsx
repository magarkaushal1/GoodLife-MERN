...
export default function UpdatePTE() {
    ...
    function handleSubmit(event) {
        ...
        let { images, des, title, content, modules, scoreScale, subtitle1,des1,subtitle2,des2,
        ...
        form_data.append("scoreScale",scoreScale)
        ...
        axios.put(`${process.env.REACT_APP_SERVER_URL}/pte/${id}`, form_data, {
            headers: {
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark " >PTE</a></li>
            ...
            <div className="container shadow my-5">
                ...
                <div className="col-md-6">
                    ...
                    <div className="col-md-12">
                        <label htmlFor="modules" className="form-label required">Modules</label>
                        <input type="modules" className="form-control" name="modules" value={data.modules}
                            onChange={handleChange}
                            aria-describedby="emailHelp" />
                        <ErrorText
                            errors={errors}
                    ...
                    <div className="col-md-12">
                        <label htmlFor="scoreScale" className="form-label required">Score Scale</label>
                        <input type="scoreScale" className="form-control" name="scoreScale" value={data.scoreScale}
                            onChange={handleChange}
                            aria-describedby="emailHelp" />
                        <ErrorText
                            errors={errors}
