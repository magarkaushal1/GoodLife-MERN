...
export default function PTE() {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_SERVER_URL}/pte`)
      .then((response) => {
        setPTE(response.data[0].data);
      })
      .catch((err) => {
        console.log(err);
      });
      ...
      <table className='table caption-top'>
        <thead>
          ...
          <tr>
            ...
            <th scope='col' className='small-th'>Modules</th>
            <th scope='col' className='small-th'>Score Scale</th>
            <th scope='col' className='small-th'>Speaking & Writing</th>
        ...
        <tbody>
          {pte.map((el, index) => (
            <tr key={el._id}>
              ...
              <td className='small-td'>{el.modules.slice(0, 100)}...</td>
              <td className='small-td'>{el.scoreScale.slice(0, 100)}...</td>
              ...
              <td>
                <div className='button' style={{ display: 'flex' }}>
                  ...
                  <Link to={`/admin/pte/update/${el._id}`}>
